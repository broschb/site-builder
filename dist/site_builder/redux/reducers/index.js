...
var selectContent = function selectContent(state, action) {
  var item = null;
  var rows = state.rows;
...
var addContent = function addContent(state, action) {
...
var resetDerivedIds = function resetDerivedIds(items, sourcePrefix) {
  for (var i = 0; i < items.length; i++) {
    items[i].derivedId = sourcePrefix + "." + i;
  }
};

var addRow = function addRow(state, action) {
...
var buildNewRow = function buildNewRow(layoutId, index) {
...
var buildNewColumn = function buildNewColumn() {
  return {
    derivedId: null,
    items: []
  };
...
var buildNewColumnItem = function buildNewColumnItem(derivedId, itemType) {
  return {
    derivedId: derivedId,
    itemType: itemType,
    itemProperties: {}
